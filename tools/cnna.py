...
SCORES_CSV_PATH = "./scores-cnna/scores.csv"
SCORES_PNG_PATH = "./scores-cnna/scores.png"
SOLVED_CSV_PATH = "./scores-cnna/solved.csv"
SOLVED_PNG_PATH = "./scores-cnna/solved.png"
...
class DQNSolver:
    ...
    def act(self, state, available_moves):
        ...
        q_values = self.model.predict(state.reshape(1,6,7,1))[0]
    ...
    def experience_replay(self):
        ...
        if not self.isFit:
            states = list(map(lambda _: _[0][0].reshape(6,7,1), batch))
...
class Cnna(Player):
    def __init__(self, env, name='Cnna'):
        super(Cnna, self).__init__(env, name)
        ...
        self.train_set_name = f"cnna_train{random.randint(1, 999)}.csv"
